...
@Component
public class MpbCashbackStrategy implements CashbackStrategy {
    ...
    public Map<DayOfWeek, Double> createPercentuals() {
        ...
        map.put(DayOfWeek.SUNDAY, Double.valueOf(30));
        map.put(DayOfWeek.MONDAY, Double.valueOf(5));
        map.put(DayOfWeek.TUESDAY, Double.valueOf(10));
        map.put(DayOfWeek.WEDNESDAY, Double.valueOf(15));
        map.put(DayOfWeek.THURSDAY, Double.valueOf(20));
        map.put(DayOfWeek.FRIDAY, Double.valueOf(25));
        map.put(DayOfWeek.SATURDAY, Double.valueOf(30));
