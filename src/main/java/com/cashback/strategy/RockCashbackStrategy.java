...
@Component
public class RockCashbackStrategy implements CashbackStrategy {
    ...
    public Map<DayOfWeek, Double> createPercentuals() {
        ...
        map.put(DayOfWeek.SUNDAY, Double.valueOf(40));
        map.put(DayOfWeek.MONDAY, Double.valueOf(10));
        map.put(DayOfWeek.TUESDAY, Double.valueOf(15));
        map.put(DayOfWeek.WEDNESDAY, Double.valueOf(15));
        map.put(DayOfWeek.THURSDAY, Double.valueOf(15));
        map.put(DayOfWeek.FRIDAY, Double.valueOf(20));
        map.put(DayOfWeek.SATURDAY, Double.valueOf(40));
