...
@RestController(Constants.API_PRODUCT_BASE_URL)
public class ProductController {

    @Autowired
    private ProductService productService;

    @GetMapping(Constants.API_PRODUCT_BASE_URL + "/by-category-pageable-orderby-name-asc")
    ...
    @GetMapping(Constants.API_PRODUCT_BASE_URL + "/{id}")
    public Mono<Product> findById(@PathVariable String id) {
        return this.productService.findById(id);
    }

    @PostMapping(Constants.API_PRODUCT_BASE_URL)
